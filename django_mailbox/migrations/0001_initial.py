    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_reply_to', models.ForeignKey(on_delete=models.CASCADE, related_name='replies', verbose_name='In reply to', blank=True, to='django_mailbox.Message', null=True)),
                ('mailbox', models.ForeignKey(on_delete=models.CASCADE, related_name='messages', verbose_name='Mailbox', to='django_mailbox.Mailbox')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=models.CASCADE, related_name='attachments', verbose_name='Message', blank=True, to='django_mailbox.Message', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
